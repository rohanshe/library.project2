...
<body>
    ...
    <!-- <form method="post" >
        ...
        <div class="form sign-in">
            ...
            <button type="submit" class="submit" name="signinbtn">Sign In</button>
    ...
    <form method="POST">
        ...
        <button type="submit" name="signinbtn">Register</button>
    </form>


    <?php

    $con = mysqli_connect('localhost', 'root', '', 'signin_signup');
